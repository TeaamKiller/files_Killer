...
database:del(bot_id..'Killer:Lock:Added:Me'..msg.chat_id_)  
...
database:set(bot_id..'Killer:Lock:Added:Me'..msg.chat_id_,true)  
...
if not database:get(bot_id..'Killer:Lock:Added:Me'..msg.chat_id_) then
...
local Added_Me = database:get(bot_id.."Killer:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
